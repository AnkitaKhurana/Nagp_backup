...
import { CatalogEventHandler } from '../Events/EventHandlers/catalogevent.handler';
import { IEvent } from '../Models/event.model';
import { PaymentEventHandler } from '../Events/EventHandlers/paymentevent.handler';
...
export class Consumer {
    ...
    private _queues: string[] = [
        constants.CART_ORDER_QUEUE,
        constants.CATALOG_ORDER_QUEUE,
        constants.PAYMENT_ORDER_QUEUE,
        constants.USER_ORDER_QUEUE
    ]
    constructor() {}
            ...
            .then((ok) => {
                ...
                this._queues.forEach((queue: string) => {
                    this._channel.consume(queue, (msg) => {
                        ...
                        CatalogEventHandler.HandleEvent(msg?.content.toString());
                        PaymentEventHandler.HandleEvent(msg?.content.toString());
                        if(msg) {
