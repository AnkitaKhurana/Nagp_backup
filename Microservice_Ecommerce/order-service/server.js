...
const { connect } = require('./src/controllers/controllerQueue')
...
app.listen(process.env.NODE_SERVER_PORT, () => {
    eurekaHelper.registerWithEureka('orderservice', process.env.NODE_SERVER_PORT);
    logger.info('Order Services running ...');
